...
> **Personal fork note:** I'm using this project to learn how multi-agent orchestration works with the OpenAI Agents SDK. My notes and experiments are in the `notes/` directory.
